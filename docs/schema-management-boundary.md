...
recorded here as a design concept so that anyone evaluating the project can see the intended
shape of the idea without mistaking it for a shipped feature.
