...
| `Db2=16384` | IBM Db2 for Linux/Unix/Windows (LUW) — dedicated `Db2Dialect`. **Only LUW is supported; Db2 for z/OS and Db2 for i are not** — see note below |
