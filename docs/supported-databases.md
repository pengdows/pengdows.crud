...
| `SingleStore=32768` | SingleStore (formerly MemSQL); detected at runtime, delegates to MySQL dialect — see note below |
| `FlatFile=65536` | [pengdows.flatfile](https://github.com/pengdows/pengdows.flatfile) — embedded ADO.NET provider over CSV/TSV/delimited/fixed-width/NDJSON files |
