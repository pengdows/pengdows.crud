...
/// <see cref="ITenantContextRegistry.AcquireLease"/>.
/// </summary>
/// <remarks>
/// Unlike <see cref="ITenantContextRegistry.GetContext"/>, which hands back a bare
/// <see cref="IDatabaseContext"/> reference with no protection against a concurrent
/// <see cref="ITenantContextRegistry.Invalidate"/>/<see cref="ITenantContextRegistry.InvalidateAll"/>
