...
namespace testbed.DriverVersionMatrix.MySqlConnector262;
...
// line? Pinned at 2.6.2, the newest stable 2.x release as of this check; sibling project
// MySqlConnector200 pins 2.0.0, the oldest stable 2.x release.
public class AllowMultipleStatementsUnsupportedTests
{
    ...
    public void SettingAllowMultipleStatements_ThrowsArgumentException()
    {
        ...
        // strongly-typed builder, across the newest stable 2.x release — empirically
