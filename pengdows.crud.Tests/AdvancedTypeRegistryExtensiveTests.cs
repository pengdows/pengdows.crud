...
public class AdvancedTypeRegistryExtensiveTests
{
    ...
    public void RegisterMapping_ClearsCacheForType()
    {
        ...
        var result1 = registry.TryConfigureParameter(param, typeof(DateTime), DateTime.Now, SupportedDatabase.SqlServer);
        Assert.False(result1);
        
        // Register mapping - should clear cache
        registry.RegisterMapping<DateTime>(SupportedDatabase.SqlServer, new ProviderTypeMapping { DbType = DbType.DateTime });
        
        // Second try - should succeed
        var result2 = registry.TryConfigureParameter(param, typeof(DateTime), DateTime.Now, SupportedDatabase.SqlServer);
        Assert.True(result2);
    ...
    public void RegisterConverter_ClearsCacheForType()
    {
        ...
        registry.RegisterMapping<Inet>(SupportedDatabase.PostgreSql, new ProviderTypeMapping { DbType = DbType.String });
    ...
    public void TryConfigureParameterEnhanced_FallsBackToProviderParameterFactory()
    {
        ...
        var result = registry.TryConfigureParameterEnhanced(param, typeof(decimal), 42.5m, SupportedDatabase.PostgreSql);
    ...
    public void Inet_PostgreSql_ConfiguresInetType()
    {
        ...
        var param = new PostgreSqlLikeParameter();
        mapping.ConfigureParameter(param, new Inet(System.Net.IPAddress.Parse("192.168.1.1")));
