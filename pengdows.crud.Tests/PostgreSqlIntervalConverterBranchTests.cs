...
namespace pengdows.crud.Tests
{
    public class PostgreSqlIntervalConverterBranchTests
    {
        ...
        public void ConvertToProvider_ReturnsValueOutsidePostgres()
        {
            ...
            var interval = new PostgreSqlInterval(1, 2, 3);
        ...
        {
            var converter = new PostgreSqlIntervalConverter();
            var interval = new PostgreSqlInterval(2, 3, 4);
            ...
            Assert.True(converter.TryConvertFromProvider(TimeSpan.FromHours(1), SupportedDatabase.PostgreSql,
                out var fromTime));
