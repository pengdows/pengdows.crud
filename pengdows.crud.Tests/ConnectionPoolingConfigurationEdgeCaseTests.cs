...
/// </summary>
internal sealed class EdgeCasePasswordStrippingBuilder : DbConnectionStringBuilder
{
    private static readonly HashSet<string> SensitiveKeys =
        new(StringComparer.OrdinalIgnoreCase) { "password", "pwd" };

    public EdgeCasePasswordStrippingBuilder(string connectionString)
    {
...
public sealed class ConnectionPoolingConfigurationEdgeCaseTests
{
    ...
    // EdgeCasePasswordStrippingBuilder simulates providers that strip on read.
