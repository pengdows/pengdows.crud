...
public class ReadOnlyModeExhaustiveWritePathTests
{
    ...
    // RetryContextScopedWrite_RejectsBeforeReachingProvider (3.0 source) exercised RetryContext,
    // which does not exist in this branch (3.0-only feature) — omitted; every other write-path
    // rejection scenario above is ported unchanged.
}
