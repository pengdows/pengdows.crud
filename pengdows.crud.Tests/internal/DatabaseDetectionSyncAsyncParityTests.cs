...
public class DatabaseDetectionSyncAsyncParityTests
{
    ...
    public static IEnumerable<object[]> Scenarios()
    {
        ...
        // Spanner discriminator scenarios (SpannerViaPostgreSqlBase / SpannerViaUnknownBase) from
        // the 3.0 source were removed — SupportedDatabase.Spanner does not exist in this branch
        // (Spanner support is 3.0-only).
        yield return new object[]
        {
