...
#pragma warning restore CS0618
    ...
    public void BrokenSentinel_IsReplacedThroughNormalConnectionPath()
    {
        ...
        // Permit accounting: the broken sentinel's reader permit was released and the
        // replacement holds exactly one — no leak, no double count.
        Assert.Equal(2, context.GetPoolStatisticsSnapshot(PoolLabel.Reader).InUse);
    }
