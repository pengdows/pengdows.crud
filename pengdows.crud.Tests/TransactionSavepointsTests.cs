...
public class TransactionSavepointsTests
{
    ...
    public async Task Savepoints_Unsupported_ThrowsNotSupported()
    {
        ...
        // updated the expectation itself: SavepointAsync used to silently no-op on an unsupported
        // dialect; it now fails fast, matching RollbackToSavepointAsync/ReleaseSavepointAsync.
        ...
        // DuckDB rejects an explicit isolation level on BeginTransaction and only supports
        // Serializable anyway — no explicit isolation level needed here.
