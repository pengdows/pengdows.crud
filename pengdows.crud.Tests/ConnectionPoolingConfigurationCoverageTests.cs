...
/// </summary>
internal sealed class CoveragePasswordStrippingBuilder : DbConnectionStringBuilder
{
    private static readonly HashSet<string> SensitiveKeys =
        new(StringComparer.OrdinalIgnoreCase) { "password", "pwd" };

    public CoveragePasswordStrippingBuilder(string connectionString)
    {
...
public sealed class ConnectionPoolingConfigurationCoverageTests
{
    ...
    // CoveragePasswordStrippingBuilder simulates providers that strip on read.
    ...
    public void ApplyPoolingDefaults_StrippingBuilder_PreservesCredentials()
    {
        ...
        var builder = new CoveragePasswordStrippingBuilder(cs);
