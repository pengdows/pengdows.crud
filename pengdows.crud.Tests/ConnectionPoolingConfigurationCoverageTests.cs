...
/// </summary>
internal sealed class PasswordStrippingBuilderForCoverageTests : DbConnectionStringBuilder
{
    private static readonly HashSet<string> SensitiveKeys =
        new(StringComparer.OrdinalIgnoreCase) { "password", "pwd" };

    public PasswordStrippingBuilderForCoverageTests(string connectionString)
    {
...
public sealed class ConnectionPoolingConfigurationCoverageTests
{
    ...
    // PasswordStrippingBuilderForCoverageTests simulates providers that strip on read.
    ...
    public void ApplyPoolingDefaults_StrippingBuilder_PreservesCredentials()
    {
        ...
        var builder = new PasswordStrippingBuilderForCoverageTests(cs);
