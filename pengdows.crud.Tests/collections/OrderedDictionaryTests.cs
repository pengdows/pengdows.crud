...
public class OrderedDictionaryTests
{
    ...
    [Fact]
    public void Constructor_WithCapacityExceedingMax_ThrowsArgumentOutOfRangeException()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() => new OrderedDictionary<string, int>(65536));
    }
    ...
    [Fact]
    public void MaxCapacity_EventuallyThrows()
    {
        var dict = new OrderedDictionary<string, int>();
        ...
        Assert.True(caughtException is InvalidOperationException or IndexOutOfRangeException);
    }
