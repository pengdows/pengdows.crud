...
public class HanaDialectTests
{
    ...
    // SupportsSavepoints bool asserted above. HANA's real capability (all three operations work
    // live) is documented in HanaDialect.cs's file-level AI SUMMARY for when this branch someday
    // gains the granular model.
