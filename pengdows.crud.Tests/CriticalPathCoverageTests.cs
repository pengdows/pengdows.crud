...
public class CriticalPathCoverageTests
{
    ...
    public void DatabaseContext_ReadOnlyContextWriteOperation_ThrowsInvalidOperation()
    {
        ...
        // Write operations on read-only context should fail. Production behavior differs from the
        // 2.0 branch: this is now the specific ReadOnlyContextException (: NotSupportedException)
        // rather than a bare NotSupportedException — see this repo's CLAUDE.md "Read-only
        // violations" section.
