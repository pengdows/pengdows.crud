...
public class NetworkConverterCoverageTests
{
    ...
    public void MacAddressConverter_UsesStringForPostgres()
    {
        ...
        // returns the underlying PhysicalAddress for PostgreSQL (Npgsql's macaddr handler binds
        // from PhysicalAddress directly) rather than a colon-separated string — see
        // MacAddressConverter.cs remarks. Updated to assert the current contract.
