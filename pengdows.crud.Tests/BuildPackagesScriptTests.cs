...
public class BuildPackagesScriptLegacyTests
{
    ...
    // =========================================================================
    // Version consistency — Directory.Build.props must declare this branch's release version.
    // =========================================================================

    [Fact]
    public void DirectoryBuildProps_Version_Is_3_0_0()
    {
        ...
        Assert.Contains("<VersionPrefix>3.0.0</VersionPrefix>", contents, StringComparison.Ordinal);
