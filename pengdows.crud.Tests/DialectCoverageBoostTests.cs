...
// Npgsql.FakeConnection (a minimal IDbConnection stub whose type lives in the "Npgsql"
// namespace, used to exercise namespace-based provider detection) is already declared in
// DialectBoundaryTests.cs — reused here rather than redeclared to avoid a duplicate-type
// compile error.
