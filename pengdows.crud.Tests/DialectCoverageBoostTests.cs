...
// Npgsql.FakeConnection is already defined in DialectBoundaryTests.cs (same shape, same
// namespace-reopening pattern) and is reused here rather than redeclared to avoid a duplicate
// type definition in the shared "Npgsql" test namespace.
