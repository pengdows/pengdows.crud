...
", tableName, idColumn, nameColumn, descriptionColumn, valueColumn, isActiveColumn, createdAtColumn,
    ...
    {
        CheckSkip("  [Spanner.GeneratedAlwaysIdentity] Spanner only supports GENERATED BY DEFAULT " +
            "AS IDENTITY, not GENERATED ALWAYS AS IDENTITY (verified live) — the explicit-identity-" +
            "upsert test's premise (overriding a GENERATED ALWAYS value) doesn't apply the same " +
            "way under BY DEFAULT semantics — skip");
