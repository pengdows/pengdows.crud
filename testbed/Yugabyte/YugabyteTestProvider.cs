...
public class YugabyteTestProvider : TestProvider
{
    ...
    /// <summary>
    /// YugabyteDB reports "This statement not supported yet" for the upsert syntax
    /// generated by the library. Skip until the dialect generates compatible SQL.
    /// </summary>
    protected override Task TestUpsertCapability()
    {
        Console.WriteLine("  [YugabyteDB] Skipping upsert capability (statement not supported yet)");
