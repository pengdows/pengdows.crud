...
// PURPOSE: [DEPRECATED] Object pool for StringBuilder instances.
//
// AI SUMMARY:
// - ENTIRE FILE IS COMMENTED OUT - replaced by StringBuilderLite.
// - Was a bounded pool for StringBuilder to reduce allocations.
// - Get(): Retrieved or created StringBuilder from pool.
// - Return(): Returned StringBuilder to pool (if under size limit).
// - MaxRetainedCapacity (4KB): Dropped oversized builders.
// - MaxPoolSize (64): Upper bound on pooled instances.
// - Superseded by stack-allocated StringBuilderLite for better performance.
// =============================================================================
