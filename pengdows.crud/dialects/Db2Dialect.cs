...
internal sealed class Db2Dialect : SqlDialect
{
    ...
    // rather than appending a trailing RETURNING/OUTPUT clause like other dialects. 2.0's
    // TableGateway.Core.cs (BuildCreateWithReturning) special-cases SupportedDatabase.Db2
    // directly to perform this wrap, matching its existing SqlServer/Oracle special cases,
    // rather than a dialect-owned WrapsInsertStatementForReturning/RenderInsertReturningPrefix
    // hook (which doesn't exist in this branch's dialect system).
